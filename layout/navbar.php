     ...
     <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="index.php" data-aos="fade-right" data-aos-duration="1000">
            <img src="assets/images/remove.png" style="width: 50px;">
          Hornbill Blog</a>
            ...
            <?php if(isset($_SESSION['user'])): ?>
              ...
              <li class="nav-item">
                <form method="post">
                  ...
                  onclick="return confirm('Are u sure to sign out?')">Sign Out</button>
                </form>
              </li>
              <?php else : ?>
              <li class="nav-item">
                <a class="nav-link" href="#signIn" data-bs-toggle="offcanvas" aria-controls="staticBackdrop">Sign In</a>
              </li>
              <li class="nav-item">
